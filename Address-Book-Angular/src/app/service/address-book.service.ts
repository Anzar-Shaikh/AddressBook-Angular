...
export class AddressBookService {
  ...
  private mainUrl  = "http://localhost:8080/address/book"
  ...
  public addAddressBookData(addressBookData : AddressBook) : Observable<any>{
    return this.httpClient.post(`${this.mainUrl}/post`, addressBookData)
  }
  ...
  public deleteAddressBookData(id : number) : Observable<any> {
    ...
    return this.httpClient.delete(`http://localhost:8080/address/book/delete/${id}`)
  }
